...
def body_frame(setup_frame:str, str_cw:int):
    ...
    cmds.button(label="Attach",command=lambda *_:auto_apply.attach(hips))
    cmds.button(label="Select",command=lambda *_:auto_apply.select(hips))
    #spine
    cmds.rowLayout(nc=4,adjustableColumn=2,cw=[1,str_cw],p=body_frame)
    cmds.text(label="Spine : ")
    spine = cmds.textField()
    textField_dic["c_spine"]=spine
    cmds.button(label="Attach",command=lambda *_:auto_apply.attach(spine))
    cmds.button(label="Select",command=lambda *_:auto_apply.select(spine))
    #chest
    cmds.rowLayout(nc=4,adjustableColumn=2,cw=[1,str_cw],p=body_frame)
    cmds.text(label="Chest : ")
    chest = cmds.textField()
    textField_dic["c_chest"]=chest
    cmds.button(label="Attach",command=lambda *_:auto_apply.attach(chest))
    cmds.button(label="Select",command=lambda *_:auto_apply.select(chest))
    #upper_chest
    cmds.rowLayout(nc=4,adjustableColumn=2,cw=[1,str_cw],p=body_frame)
    cmds.text(label="Upper Chest : ")
    upper_chest = cmds.textField()
    textField_dic["c_upperChest"]=upper_chest
    cmds.button(label="Attach",command=lambda *_:auto_apply.attach(upper_chest))
    cmds.button(label="Select",command=lambda *_:auto_apply.select(upper_chest))
    ...
    cmds.button(label="Attach",command=lambda *_:auto_apply.attach(left_shoulder))
    cmds.button(label="Select",command=lambda *_:auto_apply.select(left_shoulder))
    #upper_arm
    cmds.rowLayout(nc=4,adjustableColumn=2,cw=[1,str_cw],p=LeftArm_frame)
    cmds.text(label="Upper Arm : ")
    left_upper_arm = cmds.textField()
    textField_dic["l_upperArm"]=left_upper_arm
    cmds.button(label="Attach",command=lambda *_:auto_apply.attach(left_upper_arm))
    cmds.button(label="Select",command=lambda *_:auto_apply.select(left_upper_arm))
    #lower_arm
    cmds.rowLayout(nc=4,adjustableColumn=2,cw=[1,str_cw],p=LeftArm_frame)
    cmds.text(label="Lower Arm : ")
    left_lower_arm = cmds.textField()
    textField_dic["l_lowerArm"]=left_lower_arm
    cmds.button(label="Attach",command=lambda *_:auto_apply.attach(left_lower_arm))
    cmds.button(label="Select",command=lambda *_:auto_apply.select(left_lower_arm))
    #hand
    cmds.rowLayout(nc=4,adjustableColumn=2,cw=[1,str_cw],p=LeftArm_frame)
    cmds.text(label="Hand : ")
    left_hand = cmds.textField()
    textField_dic["l_hand"]=left_hand
    cmds.button(label="Attach",command=lambda *_:auto_apply.attach(left_hand))
    cmds.button(label="Select",command=lambda *_:auto_apply.select(left_hand))
    ...
    cmds.button(label="Attach",command=lambda *_:auto_apply.attach(right_shoulder))
    cmds.button(label="Select",command=lambda *_:auto_apply.select(right_shoulder))
    #upper_arm
    cmds.rowLayout(nc=4,adjustableColumn=2,cw=[1,str_cw],p=RightArm_frame)
    cmds.text(label="Upper Arm : ")
    right_upper_arm = cmds.textField()
    textField_dic["r_upperArm"]=right_upper_arm
    cmds.button(label="Attach",command=lambda *_:auto_apply.attach(right_upper_arm))
    cmds.button(label="Select",command=lambda *_:auto_apply.select(right_upper_arm))
    #lower_arm
    cmds.rowLayout(nc=4,adjustableColumn=2,cw=[1,str_cw],p=RightArm_frame)
    cmds.text(label="Lower Arm : ")
    right_lower_arm = cmds.textField()
    textField_dic["r_lowerArm"]=right_lower_arm
    cmds.button(label="Attach",command=lambda *_:auto_apply.attach(right_lower_arm))
    cmds.button(label="Select",command=lambda *_:auto_apply.select(right_lower_arm))
    #hand
    cmds.rowLayout(nc=4,adjustableColumn=2,cw=[1,str_cw],p=RightArm_frame)
    cmds.text(label="Hand : ")
    right_hand = cmds.textField()
    textField_dic["r_hand"]=right_hand
    cmds.button(label="Attach",command=lambda *_:auto_apply.attach(right_hand))
    cmds.button(label="Select",command=lambda *_:auto_apply.select(right_hand))
    ...
    cmds.button(label="Attach",command=lambda *_:auto_apply.attach(left_upper_leg))
    cmds.button(label="Select",command=lambda *_:auto_apply.select(left_upper_leg))
    #lower_leg
    cmds.rowLayout(nc=4,adjustableColumn=2,cw=[1,str_cw],p=LeftLeg_frame)
    cmds.text(label="Lower Leg : ")
    left_lower_leg = cmds.textField()
    textField_dic["l_lowerLeg"]=left_lower_leg
    cmds.button(label="Attach",command=lambda *_:auto_apply.attach(left_lower_leg))
    cmds.button(label="Select",command=lambda *_:auto_apply.select(left_lower_leg))
    #Foot
    cmds.rowLayout(nc=4,adjustableColumn=2,cw=[1,str_cw],p=LeftLeg_frame)
    cmds.text(label="Foot : ")
    left_foot = cmds.textField()
    textField_dic["l_foot"]=left_foot
    cmds.button(label="Attach",command=lambda *_:auto_apply.attach(left_foot))
    cmds.button(label="Select",command=lambda *_:auto_apply.select(left_foot))
    #Toes
    cmds.rowLayout(nc=4,adjustableColumn=2,cw=[1,str_cw],p=LeftLeg_frame)
    cmds.text(label="Toes : ")
    left_toes = cmds.textField()
    textField_dic["l_toes"]=left_toes
    cmds.button(label="Attach",command=lambda *_:auto_apply.attach(left_toes))
    cmds.button(label="Select",command=lambda *_:auto_apply.select(left_toes))
    ...
    cmds.button(label="Attach",command=lambda *_:auto_apply.attach(right_upper_leg))
    cmds.button(label="Select",command=lambda *_:auto_apply.select(right_upper_leg))
    #lower_leg
    cmds.rowLayout(nc=4,adjustableColumn=2,cw=[1,str_cw],p=RightLeg_frame)
    cmds.text(label="Lower Leg : ")
    right_lower_leg = cmds.textField()
    textField_dic["r_lowerLeg"]=right_lower_leg
    cmds.button(label="Attach",command=lambda *_:auto_apply.attach(right_lower_leg))
    cmds.button(label="Select",command=lambda *_:auto_apply.select(right_lower_leg))
    #Foot
    cmds.rowLayout(nc=4,adjustableColumn=2,cw=[1,str_cw],p=RightLeg_frame)
    cmds.text(label="Foot : ")
    right_foot = cmds.textField()
    textField_dic["r_foot"]=right_foot
    cmds.button(label="Attach",command=lambda *_:auto_apply.attach(right_foot))
    cmds.button(label="Select",command=lambda *_:auto_apply.select(right_foot))
    #Toes
    cmds.rowLayout(nc=4,adjustableColumn=2,cw=[1,str_cw],p=RightLeg_frame)
    cmds.text(label="Toes : ")
    right_toes = cmds.textField()
    textField_dic["r_toes"]=right_toes
    cmds.button(label="Attach",command=lambda *_:auto_apply.attach(right_toes))
    cmds.button(label="Select",command=lambda *_:auto_apply.select(right_toes))
...
def head_frame(setup_frame:str, str_cw:int):
    ...
    cmds.button(label="Attach",command=lambda *_:auto_apply.attach(neck))
    cmds.button(label="Select",command=lambda *_:auto_apply.select(neck))
    #head
    cmds.rowLayout(nc=4,adjustableColumn=2,cw=[1,str_cw],p=head_tab)
    cmds.text(label="Head : ")
    head = cmds.textField()
    textField_dic["c_head"]=head
    cmds.button(label="Attach",command=lambda *_:auto_apply.attach(head))
    cmds.button(label="Select",command=lambda *_:auto_apply.select(head))
    #left eye
    cmds.rowLayout(nc=4,adjustableColumn=2,cw=[1,str_cw],p=head_tab)
    cmds.text(label="Left Eye : ")
    left_eye = cmds.textField()
    textField_dic["l_eye"]=left_eye
    cmds.button(label="Attach",command=lambda *_:auto_apply.attach(left_eye))
    cmds.button(label="Select",command=lambda *_:auto_apply.select(left_eye))
    #right eye
    cmds.rowLayout(nc=4,adjustableColumn=2,cw=[1,str_cw],p=head_tab)
    cmds.text(label="Right Eye : ")
    right_eye = cmds.textField()
    textField_dic["r_eye"]=right_eye
    cmds.button(label="Attach",command=lambda *_:auto_apply.attach(right_eye))
    cmds.button(label="Select",command=lambda *_:auto_apply.select(right_eye))
    #jaw
    cmds.rowLayout(nc=4,adjustableColumn=2,cw=[1,str_cw],p=head_tab)
    cmds.text(label="Jaw : ")
    jaw = cmds.textField()
    textField_dic["c_jaw"]=jaw
    cmds.button(label="Attach",command=lambda *_:auto_apply.attach(jaw))
    cmds.button(label="Select",command=lambda *_:auto_apply.select(jaw))
...
def lefthand_frame(setup_frame:str, str_cw:int):
    ...
    cmds.button(label="Attach",command=lambda *_:auto_apply.attach(thumb1))
    cmds.button(label="Select",command=lambda *_:auto_apply.select(thumb1))
    #thumb2
    cmds.rowLayout(nc=4,adjustableColumn=2,cw=[1,str_cw],p=head_tab)
    cmds.text(label="Thumb Intermediate : ")
    thumb2 = cmds.textField()
    textField_dic["l_thumb2"]=thumb2
    cmds.button(label="Attach",command=lambda *_:auto_apply.attach(thumb2))
    cmds.button(label="Select",command=lambda *_:auto_apply.select(thumb2))
    #thumb1
    cmds.rowLayout(nc=4,adjustableColumn=2,cw=[1,str_cw],p=head_tab)
    cmds.text(label="Thumb Distal : ")
    thumb3 = cmds.textField()
    textField_dic["l_thumb3"]=thumb3
    cmds.button(label="Attach",command=lambda *_:auto_apply.attach(thumb3))
    cmds.button(label="Select",command=lambda *_:auto_apply.select(thumb3))
    ...
    cmds.button(label="Attach",command=lambda *_:auto_apply.attach(index1))
    cmds.button(label="Select",command=lambda *_:auto_apply.select(index1))
    #index2
    cmds.rowLayout(nc=4,adjustableColumn=2,cw=[1,str_cw],p=head_tab)
    cmds.text(label="Index Intermediate : ")
    index2 = cmds.textField()
    textField_dic["l_index2"]=index2
    cmds.button(label="Attach",command=lambda *_:auto_apply.attach(index2))
    cmds.button(label="Select",command=lambda *_:auto_apply.select(index2))
    #index1
    cmds.rowLayout(nc=4,adjustableColumn=2,cw=[1,str_cw],p=head_tab)
    cmds.text(label="Index Distal : ")
    index3 = cmds.textField()
    textField_dic["l_index3"]=index3
    cmds.button(label="Attach",command=lambda *_:auto_apply.attach(index3))
    cmds.button(label="Select",command=lambda *_:auto_apply.select(index3))
    ...
    cmds.button(label="Attach",command=lambda *_:auto_apply.attach(middle1))
    cmds.button(label="Select",command=lambda *_:auto_apply.select(middle1))
    #middle2
    cmds.rowLayout(nc=4,adjustableColumn=2,cw=[1,str_cw],p=head_tab)
    cmds.text(label="Middle Intermediate : ")
    middle2 = cmds.textField()
    textField_dic["l_middle2"]=middle2
    cmds.button(label="Attach",command=lambda *_:auto_apply.attach(middle2))
    cmds.button(label="Select",command=lambda *_:auto_apply.select(middle2))
    #middle1
    cmds.rowLayout(nc=4,adjustableColumn=2,cw=[1,str_cw],p=head_tab)
    cmds.text(label="Middle Distal : ")
    middle3 = cmds.textField()
    textField_dic["l_middle3"]=middle3
    cmds.button(label="Attach",command=lambda *_:auto_apply.attach(middle3))
    cmds.button(label="Select",command=lambda *_:auto_apply.select(middle3))
    ...
    cmds.button(label="Attach",command=lambda *_:auto_apply.attach(ring1))
    cmds.button(label="Select",command=lambda *_:auto_apply.select(ring1))
    #ring2
    cmds.rowLayout(nc=4,adjustableColumn=2,cw=[1,str_cw],p=head_tab)
    cmds.text(label="Ring Intermediate : ")
    ring2 = cmds.textField()
    textField_dic["l_ring2"]=ring2
    cmds.button(label="Attach",command=lambda *_:auto_apply.attach(ring2))
    cmds.button(label="Select",command=lambda *_:auto_apply.select(ring2))
    #ring1
    cmds.rowLayout(nc=4,adjustableColumn=2,cw=[1,str_cw],p=head_tab)
    cmds.text(label="Ring Distal : ")
    ring3 = cmds.textField()
    textField_dic["l_ring3"]=ring3
    cmds.button(label="Attach",command=lambda *_:auto_apply.attach(ring3))
    cmds.button(label="Select",command=lambda *_:auto_apply.select(ring3))
    ...
    cmds.button(label="Attach",command=lambda *_:auto_apply.attach(little1))
    cmds.button(label="Select",command=lambda *_:auto_apply.select(little1))
    #little2
    cmds.rowLayout(nc=4,adjustableColumn=2,cw=[1,str_cw],p=head_tab)
    cmds.text(label="Little Intermediate : ")
    little2 = cmds.textField()
    textField_dic["l_little2"]=little2
    cmds.button(label="Attach",command=lambda *_:auto_apply.attach(little2))
    cmds.button(label="Select",command=lambda *_:auto_apply.select(little2))
    #little1
    cmds.rowLayout(nc=4,adjustableColumn=2,cw=[1,str_cw],p=head_tab)
    cmds.text(label="Little Distal : ")
    little3 = cmds.textField()
    textField_dic["l_little3"]=little3
    cmds.button(label="Attach",command=lambda *_:auto_apply.attach(little3))
    cmds.button(label="Select",command=lambda *_:auto_apply.select(little3))
